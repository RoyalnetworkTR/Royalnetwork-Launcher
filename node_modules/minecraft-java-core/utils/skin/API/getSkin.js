...
module.exports = new class skin {
    ...
    async SkinChangeURL(data) {
        let skin = await nodeFetch("https://mc.royalnetwork.xyz/minecraft/profile/skins", {
            method: "POST",
            headers: {
    ...
    async SkinDelete(data) {
        let skin = await nodeFetch("https://mc.royalnetwork.xyz/minecraft/profile/skins/active", {
            method: "DELETE",
            headers: {
                'Authorization': `Bearer ${data.access_token}`
            }
    ...
    async CapeChange(data) {
        let skin = await nodeFetch("https://mc.royalnetwork.xyz/minecraft/profile/capes/active", {
            method: "PUT",
            headers: {
                'Authorization': `Bearer ${data.access_token}`,
                'Content-Type': 'application/json'
